...
const CadastrarJogoScreen = () => {
  ...
  const handleCadastrar = async () => {
    ...
    try {
      ...
      Alert.alert('Erro', error.message || 'Não foi possível cadastrar o jogo.');
    }
  };
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 50 }}>
      ...
      <TextInput style={styles.input} placeholder="Tipo (ex: Society)" placeholderTextColor="#888" value={tipo} onChangeText={setTipo} />
